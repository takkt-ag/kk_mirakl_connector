...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[PingResponse200]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[PingResponse200]:
    return Response(
