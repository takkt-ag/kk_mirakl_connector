...
T = TypeVar("T", bound="StoreToTransportResponse400Errors")


@attr.s(auto_attribs=True)
class StoreToTransportResponse400Errors:
    """
    Example:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        store_to_transport_response_400_errors = cls(
            source_file=source_file,
            remote_file=remote_file,
        )

        store_to_transport_response_400_errors.additional_properties = d
        return store_to_transport_response_400_errors
