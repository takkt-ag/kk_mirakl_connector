...
T = TypeVar("T", bound="StoreToInternalStorageInput")


@attr.s(auto_attribs=True)
class StoreToInternalStorageInput:
    """
    Example:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        store_to_internal_storage_input = cls(
            source_file=source_file,
            remote_file=remote_file,
        )

        store_to_internal_storage_input.additional_properties = d
        return store_to_internal_storage_input
