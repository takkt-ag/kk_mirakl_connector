...
if TYPE_CHECKING:
    from ..models.csa_classifications_list_response_200_data_item import CsaClassificationsListResponse200DataItem
...
class CsaClassificationsListResponse200:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = CsaClassificationsListResponse200DataItem.from_dict(data_item_data)
