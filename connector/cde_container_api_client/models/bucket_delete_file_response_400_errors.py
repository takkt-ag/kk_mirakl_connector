...
T = TypeVar("T", bound="BucketDeleteFileResponse400Errors")


@attr.s(auto_attribs=True)
class BucketDeleteFileResponse400Errors:
    """
    Example:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        bucket_delete_file_response_400_errors = cls(
            remote_file=remote_file,
        )

        bucket_delete_file_response_400_errors.additional_properties = d
        return bucket_delete_file_response_400_errors
